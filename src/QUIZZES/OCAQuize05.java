...
public static void main(String[] args) {
		...
		/*
		 ...
		 C.	Compilation fails					D.	A   Work done		 
		...
		/*
		 ...
		 C.	10.0											D.	An exception is thrown at runtime
		...
		/*
		 ...
		 8.	What's the result of the following code fragment? 
          ...
          A.	Exception is thrown at run time						B.	1 2 3
