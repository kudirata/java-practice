...
public class PopularNameArrays {
...
"Johnny","Kayla
		 */
		// Create a String array names and assign values for names.
		...
		// 1. Find out number of names in this array, print out
		
		System.out.println("Total names: " + names.length);
		System.out.println();
		
		// 2. PRINT ARRAY IN ONE LINE AS A STRING
		System.out.println(Arrays.deepToString(names));  
		System.out.println();
		
		// 3. PRINT IN COLUMN FORMAT, 2 NAMES IN EACH LINE
		...
		System.out.println();
		// 4. PRINT MALE NAMES IN SINGLE LINE SEPARATED BY COMMA
		...
		// 5. PRINT FEMALE NAMES
		
			for (int z = 1; z < names.length; z+=2) {
			...
			System.out.println();
			System.out.println();
			// 6. PRINT 1 RANDOM NAME FROM THIS ARRAY
			// USE RANDOM CLASS
			...
			System.out.println();
			System.out.println();
			// 7. PRINT ALL NAMES THAT ARE UP TO FOUR CHARACTERS, IN UPPERCASE, IN SAME LINE
			
			System.out.println("NAMES THAT ARE UP TO 4 CHARACTERS IN UPPER CASE");
